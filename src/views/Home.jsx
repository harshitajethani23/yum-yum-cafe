...
function Home() {
  return (
    <div >
       ...
       <div>
        <h2 className="text-center text-4xl text-[#CD2C58]">About us</h2>
        <p className="text-center mr-8 ml-8">Welcome to Yum Yum Café, your cozy corner for coffee, comfort, and community. What started as a simple love for good coffee and fresh, homemade food has grown into a local gathering spot where friends meet, ideas spark, and every bite feels like home.We believe in the power of quality ingredients, friendly faces, and that little “yum” moment with every sip. Whether you’re here for your morning latte, a quiet spot to work, or a weekend brunch with friends, there’s always something delicious waiting.</p>
        <h2 className="text-center text-4xl">Come for the <span className="bg-[#E06B80] px-4 py-1 rounded-md text-white inline-block mt-6 md:mt-0">coffee.</span> Stay for the  <span className="bg-[#E06B80] px-4 py-1 rounded-md text-white inline-block mt-6 md:mt-0">vibes.</span></h2>
         <div>
         <h2 className="text-center text-4xl text-[#CD2C58]">Ambience</h2>
